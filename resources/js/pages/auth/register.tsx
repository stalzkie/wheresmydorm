...
export default function Register() {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        if (data.role === 'student') {
            Object.assign(submitData, {
                ...
                guardian_contact_no: data.guardian_contact_no || undefined,
            });
    ...
    const renderStep1 = () => (
        <div className="space-y-6">
            <div>
                <h3 className="mb-4 text-lg font-semibold">Who are you?</h3>
                <Select value={data.role} onValueChange={(value: 'student' | 'dorm') => setData('role', value)}>
                    <SelectTrigger>
                        <SelectValue placeholder="Select your role" />
                    </SelectTrigger>
                    <SelectContent>
                        <SelectItem value="student">I'm a Student looking for a place</SelectItem>
                        <SelectItem value="dorm">I'm a Dorm Manager / Owner</SelectItem>
                    </SelectContent>
                </Select>
        ...
        <div className="space-y-4">
            ...
            <div className="grid gap-4">
                <div>
                    ...
                    <Input id="name" required value={data.name} onChange={(e) => setData('name', e.target.value)} placeholder="Juan Dela Cruz" />
    ...
    const renderStep3 = () => (
        <div className="space-y-4">
            <h3 className="text-lg font-semibold">{data.role === 'student' ? 'Student Information' : 'Dormitory Information'}</h3>
            ...
            {data.role === 'student' ? (
                <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                        <h4 className="font-medium text-muted-foreground">Additional Details (Optional)</h4>
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <Input id="cover_photo" type="file" accept="image/*" onChange={(e) => setData('cover_photo', e.target.files?.[0] || null)} />
